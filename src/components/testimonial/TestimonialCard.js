...
const TestimonialCard = ({ testimonial }) => {
    return (
        <div className="md:w-[100vw] h-[80vh] md:h-[85vh] lg:h-[90vh] xl:h-[75vh]">
            <div className="bg-gray-200 mt-10 w-full h-[400px] md:w-[350px] lg:w-[300px] lg:h-[470px] xl:w-[400px] xl:h-[410px] rounded-[10px] flex flex-col justify-center items-center relative opacity-90">
