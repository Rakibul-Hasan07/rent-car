...
export default function Search() {
  ...
  return (
    <div className='flex flex-col items-center justify-center my-8 mx-4'>
      ...
      <div>
        <form className='grid sm:grid-cols-2 lg:grid-cols-3 xl:flex gap-1 md:gap-3 items-center'>
          {/* City selection */}
          <div className="mb-4">
          ...
          {/* Submit button  */}
          <div>
            <button type='submit' className='bg-sky-500 w-72 xl:w-60 rounded-lg p-4 mt-3 text-white text-sm'>Search</button>
          </div>
        </form>
      </div>
    </div>
