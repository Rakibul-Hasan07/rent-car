...
export default function addCar() {
    ...
    const handleSubmit = async (e) => {
        ...
        const carNumberOfBags = e.target.carNumberOfBags.value;
            ...
            <form onSubmit={handleSubmit} className="mx-auto mt-10 max-w-xl sm:mt-20">
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div className="relative mt-2.5">
                            <select name="carNumberOfBags" className="block appearance-none w-full border border-gray-200 py-3 px-4 pr-8 
                            rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
